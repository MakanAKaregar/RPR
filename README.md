...
# 1. Installation guide for RPR <a name="#RPRInst"></a> 
...
# 2. Photovoltaic energy system for the RPR<a name="solarPanel"></a> (#solarPanel)
...
# 3. Installing nextCloud on the RPR <a name="#nextCloud"></a> (#nextCloud)
