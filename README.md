...
## 1.2 Installing Arduino integrated development environment (IDE)
 ...
 General instructions for soldering Adafruit GPS FeatherWing, Adafruit Feather Adalogger microcontroller and stackable header can be found here: follow Section 2.1 in [Tutorial Adafruit GNSS-R.pdf] (https://github.com/fgnievinski/mphw/blob/main/docs/):
